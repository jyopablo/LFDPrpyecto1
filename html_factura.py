...
def crear(Factura):
    ...
    crear.write("<title>Factura#"+str(Factura)+"</title></head><body><div class=\"container\"><div class=\"row justify-content-center  align-items-center vh-100\"><div class=\"card shadow p-3\" style=\"width: 50rem;\"><div class=\"card-body\"><h3 class=\"card-title\"><div class=\"row justify-content-center\">"+titulo[0]+"</div></h3>")
    ...
    for i in range(0,y):
        ...
        crear.write("<td>"+str(precioProducto[j])+"</td>")
